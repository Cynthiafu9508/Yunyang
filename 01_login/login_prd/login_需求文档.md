...
登录页面提供手机号+验证码的快速登录方式，包含7个核心功能：应用LOGO展示、手机号输入、验证码获取、验证码输入、立即登录、切换登录方式、用户协议同意。
...
- 必须同意用户协议
- 登录成功后记录登录日志
- 新用户自动注册随机生成用户名并赠送1个人物创建额度及50心跳值。
...
- [ ] 新用户自动注册，赠送1个创建额度及50心跳值
- [ ] 切换登录方式跳转正确 (password_login.html)
- [ ] 协议未勾选时阻止登录
