...
graph TD
    ...
    style Tab2 fill:#96ceb4,stroke:#333,stroke-width:2px,color:#fff
    style Tab3 fill:#feca57,stroke:#333,stroke-width:2px,color:#fff
    style Upload fill:#ff9ff3,stroke:#333,stroke-width:2px,color:#fff
    style CharCreate fill:#54a0ff,stroke:#333,stroke-width:2px,color:#fff
    style Chat fill:#5f27cd,stroke:#333,stroke-width:2px,color:#fff
    style CharView fill:#00d2d3,stroke:#333,stroke-width:2px,color:#fff
    style CharEdit fill:#ff9f43,stroke:#333,stroke-width:2px,color:#fff
    style Recharge fill:#ee5a24,stroke:#333,stroke-width:2px,color:#fff
    style Forgot1 fill:#a55eea,stroke:#333,stroke-width:2px,color:#fff
    style Forgot2 fill:#26de81,stroke:#333,stroke-width:2px,color:#fff
```
...
graph LR
    ...
    style A1 fill:#ff9ff3,stroke:#333,stroke-width:2px,color:#fff
    style M1A fill:#45b7d1,stroke:#333,stroke-width:2px,color:#fff
    style M1B fill:#ff9ff3,stroke:#333,stroke-width:2px,color:#fff
    style M1C fill:#54a0ff,stroke:#333,stroke-width:2px,color:#fff
    style M2A fill:#96ceb4,stroke:#333,stroke-width:2px,color:#fff
    style M2B fill:#5f27cd,stroke:#333,stroke-width:2px,color:#fff
    style M2C fill:#00d2d3,stroke:#333,stroke-width:2px,color:#fff
    style M2D fill:#ff9f43,stroke:#333,stroke-width:2px,color:#fff
    style M3A fill:#feca57,stroke:#333,stroke-width:2px,color:#fff
    style M4A fill:#ee5a24,stroke:#333,stroke-width:2px,color:#fff
    style AS1 fill:#a55eea,stroke:#333,stroke-width:2px,color:#fff
    style AS2 fill:#26de81,stroke:#333,stroke-width:2px,color:#fff
```
