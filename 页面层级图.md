...
graph TD
    ...
    style CharCreate fill:#96ceb4,stroke:#333,stroke-width:2px,color:#fff
    style Chat fill:#96ceb4,stroke:#333,stroke-width:2px,color:#fff
    style CharView fill:#96ceb4,stroke:#333,stroke-width:2px,color:#fff
    style CharEdit fill:#96ceb4,stroke:#333,stroke-width:2px,color:#fff
...
graph LR
    ...
    style M1C fill:#96ceb4,stroke:#333,stroke-width:2px,color:#fff
    style M2A fill:#45b7d1,stroke:#333,stroke-width:2px,color:#fff
    style M2B fill:#96ceb4,stroke:#333,stroke-width:2px,color:#fff
    style M2C fill:#96ceb4,stroke:#333,stroke-width:2px,color:#fff
    style M2D fill:#96ceb4,stroke:#333,stroke-width:2px,color:#fff
