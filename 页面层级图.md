...
graph TD
    ...
    style PasswordLogin fill:#d3d3d3,stroke:#333,stroke-width:2px,color:#000
    style ForgotMain fill:#d3d3d3,stroke:#333,stroke-width:2px,color:#000
    style Forgot1 fill:#d3d3d3,stroke:#333,stroke-width:2px,color:#000
    style Forgot2 fill:#d3d3d3,stroke:#333,stroke-width:2px,color:#000
```
...
### 表2：同一页面多模式对比（character-profile.html）
